...
router.post('/:groupId/tables/:tableName', groupController.getSelectedColumn)
router.post('/:groupId/tables/:tableName/columnData', groupController.getSelectedColumnById)
